...
/// MortalityDisplay
/// Draw the screen that comes up when puma dies
...
public class MortalityDisplay : MonoBehaviour
{
	...
	{ 
		...
		GUI.color = new Color(1f, 1f, 1f, 0.5f * carCollisionOpacity);
		GUI.Box(new Rect(boxX, boxY, boxW, boxH), "");
		GUI.color = new Color(1f, 1f, 1f, 1f * carCollisionOpacity);
		...
		guiComponents.DrawPumaHealthBar(guiManager.selectedPuma, carCollisionOpacity, barX, barY, barW, barH);
		...
		GUI.Box(new Rect(feedingDisplayX + feedingDisplayWidth * 0.335f, feedingDisplayY + feedingDisplayHeight * 0.3f, feedingDisplayWidth * 0.33f, feedingDisplayHeight * 0.30f), "");
		GUI.color = new Color(1f, 1f, 1f, 0.9f * starvedOpacity);
		...
		//GUI.color = new Color(1f, 1f, 1f, 0.4f * starvedOpacity);
		//GUI.Box(new Rect(feedingDisplayX + feedingDisplayWidth * 0.43f, feedingDisplayY + feedingDisplayHeight * 0.43f, feedingDisplayWidth * 0.14f, feedingDisplayHeight * 0.127f), "");
		...
		guiComponents.DrawMeatBar(starvedOpacity, feedingDisplayX + feedingDisplayWidth * 0.040f + feedingDisplayHeight * 0.03f, feedingDisplayY + feedingDisplayHeight * 0.77f, feedingDisplayWidth * 0.29f - feedingDisplayHeight * 0.06f, feedingDisplayHeight * 0.12f);
		...
		GUI.color = new Color(1f, 1f, 1f, 0.5f * starvedOpacity);
		GUI.Box(new Rect(feedingDisplayX + feedingDisplayWidth * 0.665f, feedingDisplayY + feedingDisplayHeight * 0.3f, feedingDisplayWidth * 0.3f, feedingDisplayHeight * 0.62f), "");
		GUI.color = new Color(1f, 1f, 1f, 1f * starvedOpacity);
		...
		//starvedOpacity = 1f - (statusPanelOpacityDrop * 0.25f);
		//GUI.color = new Color(1f, 1f, 1f, 1f * starvedOpacity);
		...
		textureHeight = headshotTexture.height * (textureWidth / headshotTexture.width);
		GUI.DrawTexture(new Rect(textureX, textureY, textureWidth, textureHeight), headshotTexture);
		//starvedOpacity = starvedOpacity * statusPanelOpacity;
		//GUI.color = new Color(1f, 1f, 1f, 1f * starvedOpacity);

		// puma name
		//starvedOpacity = 1f - (statusPanelOpacityDrop * 0.75f);
		//GUI.color = new Color(1f, 1f, 1f, 1f * starvedOpacity);
		style.normal.textColor = new Color(0.99f * 0.9f, 0.63f * 0.8f, 0f, 1f);
		style.fontSize = (int)(fontRef * 0.13f);
		...
		guiComponents.DrawPumaHealthBar(guiManager.selectedPuma, starvedOpacity, feedingDisplayX + feedingDisplayWidth * 0.670f + feedingDisplayHeight * 0.03f, feedingDisplayY + feedingDisplayHeight * 0.775f, feedingDisplayWidth * 0.29f - feedingDisplayHeight * 0.06f, feedingDisplayHeight * 0.11f);
		...
		GUI.color = new Color(1f, 1f, 1f, 1f * starvedOpacity);
		guiComponents.DrawPopulationHealthBar(starvedOpacity, feedingDisplayX + feedingDisplayWidth * 0.035f, feedingDisplayY + feedingDisplayHeight * 0.99f, feedingDisplayWidth * 0.93f, feedingDisplayHeight * 0.145f, true, true);
		...
		if (GUI.Button(new Rect(feedingDisplayX + feedingDisplayWidth * 0.81f,  feedingDisplayY + feedingDisplayHeight * 0.727f, feedingDisplayWidth * 0.14f, feedingDisplayHeight * 0.25f), "Go")) {
			guiManager.SetGuiState("guiStateLeavingPumaDied");
